...
const resources = {
    en: {
        translation: {
            ...
            chart_warning: 'Bear in mind, that average price per period is displayed.',
    ...
    lv: {
        translation: {
            ...
            chart_warning: 'Ņemiet vērā, ka tiek attēlota vidējā cena par periodu.',
    ...
    ru: {
        translation: {
            ...
            chart_warning: 'Обратите внимание, что отображается средняя цена за период.',
